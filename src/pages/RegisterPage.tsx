...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-white dark:from-gray-900 dark:to-gray-800 py-4 md:py-12 px-2 sm:px-6 lg:px-8">
      <div className="max-w-xl w-full space-y-4 md:space-y-6 bg-white dark:bg-gray-800 shadow-2xl rounded-xl p-4 md:p-6 border border-gray-100 dark:border-gray-700">
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-1 md:text-base text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 h-[42px] border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-300 ease-in-out dark:bg-gray-700 dark:text-white appearance-none"
              />
            </div>
          </div>
