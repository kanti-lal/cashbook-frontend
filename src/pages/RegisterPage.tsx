          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-300 ease-in-out bg-white  text-gray-900 appearance-none"
              />
            </div>
          </div>
