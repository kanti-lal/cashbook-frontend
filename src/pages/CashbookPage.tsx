...
export default function CashbookPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Sticky header */}
      <div className="flex-none bg-gray-50 dark:bg-gray-900 sticky top-0 z-10">
      ...
      <div className="flex-1 overflow-y-auto max-w-md md:max-w-4xl mx-auto w-full border-t border-gray-200 dark:border-gray-700">
